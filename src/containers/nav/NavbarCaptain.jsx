...
const navigation = [
    ...
    //     href: "/captain/monitoring"
    // },
    // {
    //     section: "Menu",
    //     icon: <ShieldCheckIcon className="w-5 h-5" />,
    //     items: [
    //         { name: "History", href: "/captain/history", icon: <ClockIcon className="w-4 h-4" /> },
    //     ],
    // }
];
...
export default function NavbarCaptain({ children }) {
                ...
                <div className="sticky top-0 z-10 flex h-16 items-center bg-white shadow-sm px-6 border-b border-gray-200">
                    ...
                    <div className="flex-1 min-w-0">
                        <h1 className="text-xl font-semibold text-gray-900 ml-2 lg:ml-0">
                            <KeyIcon className="h-6 w-6 inline-block mr-2 text-blue-600" />
                            Captain Dashboard
                        </h1>
