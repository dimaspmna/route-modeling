...
const navigation = [
    ...
    },
    {
        ...
        items: [
            { name: "History", href: "/passenger/history", icon: <ClockIcon className="w-4 h-4" /> },
        ],
    }
];
            ...
            <div className="flex flex-1 flex-col lg:pl-64">
                <div className="sticky top-0 z-10 flex h-16 items-center bg-white shadow-sm px-6 border-b border-gray-200">
                    ...
                    <div className="flex-1 min-w-0">
                        <h1 className="text-xl font-semibold text-gray-900 ml-2 lg:ml-0">Passenger Dashboard</h1>
                    </div>
                            ...
                            <Menu.Button className="flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-2 hidden md:block">
                                        ...
                                        <p className="text-xs text-gray-500">
                                            {userData?.role ? userData.role.charAt(0).toUpperCase() + userData.role.slice(1) : 'Passenger'}
                                        </p>
                                    </div>
                                </div>
                            </Menu.Button>
