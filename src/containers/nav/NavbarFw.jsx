...
const navigation = [
    ...
    },
    {
        ...
        items: [
            { name: "History", href: "/fw/history", icon: <ClockIcon className="w-4 h-4" /> },
        ],
    }
];
...
export default function NavbarFw({ children }) {
            ...
            <div className="flex flex-1 flex-col lg:pl-64">
                <div className="sticky top-0 z-10 flex h-16 items-center bg-white shadow-sm px-6 border-b border-gray-200">
                    ...
                    <div className="flex-1 min-w-0">
                        <h1 className="text-xl font-semibold text-gray-900 ml-2 lg:ml-0">Fresh Water Dashboard</h1>
